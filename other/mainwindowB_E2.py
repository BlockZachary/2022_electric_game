...
# Form implementation generated from reading ui file 'mainwindowB_E2.ui'
#
...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.button_video.setGeometry(QtCore.QRect(50, 120, 141, 41))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.button_recognize.setGeometry(QtCore.QRect(210, 120, 141, 41))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        ...
        self.textBrowser.setGeometry(QtCore.QRect(50, 220, 301, 371))
        self.textBrowser.setObjectName("textBrowser")
        self.button_medicare = QtWidgets.QPushButton(self.centralwidget)
        self.button_medicare.setGeometry(QtCore.QRect(210, 170, 141, 41))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(12)
        ...
        self.label.setGeometry(QtCore.QRect(130, 180, 72, 21))
        font = QtGui.QFont()
        font.setFamily("黑体")
        ...
        self.lineEdit_treatement_time.setGeometry(QtCore.QRect(90, 180, 41, 26))
        self.lineEdit_treatement_time.setMinimumSize(QtCore.QSize(0, 5))
        self.lineEdit_treatement_time.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.lineEdit_treatement_time.setObjectName("lineEdit_treatement_time")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(50, 180, 41, 21))
        font = QtGui.QFont()
        font.setFamily("黑体")
        font.setPointSize(11)
